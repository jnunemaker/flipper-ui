(function() {
  ...
  Gate = (function(_super) {
    ...
    Gate.prototype.url = function() {
      return "/features/" + (encodeURIComponent(this.feature_id)) + "/" + (encodeURIComponent(this.name));
    };
  ...
  App.FeatureList = (function(_super) {
    ...
    function FeatureList() {
      ...
      this.routes({
        ...
        '/features/:id/:gate': function(params) {
          var controller;
          if (controller = this.features[params.id]) {
            controller.edit();
  ...
  App.Feature = (function(_super) {
    ...
    Feature.prototype.openFeature = function(event) {
      ...
      return this.navigate("/features/" + this.feature.id);
    };

    Feature.prototype.openDefaultGate = function() {
      return this.navigate("/features/" + this.feature.id + "/boolean");
    };
    ...
    Feature.prototype.clickTab = function(event) {
      ...
      return this.navigate("/features/" + this.feature.id + "/" + name);
    };
